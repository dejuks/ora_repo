// src/pages/reviewer/EbookReviewerRejectedPage.jsx
...
export default function EbookReviewerRejectedPage() {
  ...
  const loadData = async () => {
    try {
      ...
      const res = await axios.get(
        `${API}/oraebook/reviewer/rejected`,
        {
          headers: {
      ...
      console.error(error);
      alert("Failed to load rejected reviews");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <MainLayout>
      <div className="review-page">
        ...
        {/* ================= HEADER ================= */}
        <div className="review-header rejected-header">

          <div>
            <h1>Rejected Reviews</h1>

            <p>
              Monitor rejected manuscript reviews and declined evaluations
            </p>
          </div>
                  ...
                  {rows.map((item, index) => (
                    ...
                    <tr key={item.assignment_id}>
                      ...
                      <td>
                        ...
                        <span className="recommendation-pill rejected-pill">
                          {item.recommendation || "-"}
                        </span>
        ...
        {selectedReview && (
          ...
          <div className="custom-modal-overlay">
            ...
            <div className="custom-modal">
              ...
              {/* HEADER */}
              <div className="custom-modal-header rejected-modal-header">

                <div>

                  <h2>Rejected Review Details</h2>

                  <p>
                    Detailed information about rejected manuscript review
                  </p>
