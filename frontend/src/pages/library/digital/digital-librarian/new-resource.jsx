...
export default function Page() {
  return (
    <ResourcePage
      title="Digital / Digital Librarian / New Resource"
      subtitle="Create a new digital resource entry."
      resource="digital-resources"
      idField="digital_resource_id"
      columns={[{ key: 'material_id', label: 'Material' }, { key: 'publisher_id', label: 'Publisher' }, { key: 'access_level', label: 'Access' }, { key: 'is_downloadable', label: 'Downloadable' }]}
