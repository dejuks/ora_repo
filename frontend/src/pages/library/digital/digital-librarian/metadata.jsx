...
export default function Page() {
  return (
    <ResourcePage
      title="Digital / Digital Librarian / Metadata"
      subtitle="Maintain digital submission metadata before publication."
      resource="digital-submissions"
      idField="submission_id"
      columns={[{ key: 'title', label: 'Title' }, { key: 'material_type_id', label: 'Type' }, { key: 'category_id', label: 'Category' }, { key: 'language_id', label: 'Language' }, { key: 'status', label: 'Status' }]}
