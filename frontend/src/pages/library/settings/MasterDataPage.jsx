    ...
    <MainLayout>
      ...
      <section className="content"><div className="container-fluid">
            ...
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div className="d-flex align-items-center" style={{ gap: 8 }}>
                  <button className="btn btn-primary" type="button" onClick={() => { setEditing(null); setForm(emptyForm); setIsFormOpen(true); }}>Create New</button>
        ...
        <CrudModal
          ...
          footer={(<>
            <button className="btn btn-secondary" type="button" onClick={() => setIsFormOpen(false)}>Close</button>
            <button className="btn btn-primary" type="button" onClick={submit}>{editing ? 'Update' : 'Create'}</button>
          </>)}
        >
