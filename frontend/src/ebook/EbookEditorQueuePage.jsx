    ...
    <MainLayout>
      <section className="content-header mb-3">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
          <div>
            <h1 className="mb-1">Editor Queue</h1>
            <p className="text-muted mb-0">Filter submissions by stage, monitor review progress, and hand off accepted items to production.</p>
          </div>
