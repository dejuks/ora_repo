...
CREATE TABLE permissions (
  ...
  module_group VARCHAR(100) DEFAULT 'System Wide'
);
...
('ebook.submit'),
('ebook.view_own'),
('ebook.version.upload'),
('ebook.revision.submit'),
('ebook.history.view_own'),

-- EDITOR
('ebook.view_all'),
('ebook.screening.queue'),
('ebook.screening.start'),
('ebook.screening.assess'),
('ebook.review.assign'),
('ebook.review.summary'),
('ebook.decision.accept'),
('ebook.decision.revision'),
('ebook.decision.reject'),
('ebook.history.view_all'),
...
-- FINANCE
('ebook.finance.queue'),
('ebook.finance.decision'),
('ebook.finance.view'),

-- DIGITAL CONTENT MANAGER
('ebook.production.queue'),
('ebook.production.upload_final'),
('ebook.publication.metadata.update'),
('ebook.publish'),
('ebook.publication.view'),

-- PUBLIC / LIBRARY
('ebook.public.view'),
('ebook.public.download_restricted'),
