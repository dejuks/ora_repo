...
import ebookRoutes from "./ebooks/routes/ebook.routes.js";
import ebookAuthRoutes from "./ebooks/routes/ebook.auth.routes.js";
...
app.use("/api/ebooks/author", ebookAuthorRoutes);
app.use("/ebooks", ebookRoutes);
app.use("/api/ebook", ebookAuthRoutes);
